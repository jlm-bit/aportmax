...
with tab1:
    ...
    if ya_aportado > max_p: 
        ...
        st.warning("⚠️ Nota, de acuerdo a tu planificacion te vas a pasar de aportación. Revisa datos y/o reduce aportación futura. Ver Plan de Acción.")ng("⚠️ Nota, de acuerdo a tu planificacion te vas a pasar de aportació, Revisa datos y/o reduce aportación futura. Ver Plan de Acción .")
