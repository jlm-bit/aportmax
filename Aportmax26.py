...
with tab1:
 ...
 # --- 3. DESGLOSE COMPACTO (4 COLUMNAS) ---
    ...
    with c3:
        st.markdown(f"<p style='margin:0; font-size:0.6rem;'><b>✅ % cumplimiento</b></p><h4 style='margin:0; font-size:1.1rem;'>{cumplimiento_plan:,.0f}%</h4>", unsafe_allow_html=True) st.markdown(f"<p style='margin:0; font-size:0.6rem;'><b>⏳ % cumplimiento</b></p><h4 style='margin:0; font-size:1.1rem;'>{cumplimiento_plan:,.0f}%)
    with c3:
