...
st.markdown(
    ...
    <div style="display: flex; justify-content: space-around; align-items: center; padding: 15px; border: 1px solid #e6e9ef; border-radius: 8px;">
        ...
        <div style="text-align: center;">
            <p style="margin:0; color: #64748b; font-size: 0.8em; text-transform: uppercase;">Aportación Personal Neta IRPF</p>
            <p style="margin:0; font-size: 1.5em; font-weight: bold; color: #1E3A8A;">{coste_neto_trabajador:,.2f} €</p>
        <div style="height: 40px; border-left: 1px solid #e6e9ef;"></div>
        </div>
    </div>
    """, 
