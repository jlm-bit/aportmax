    ...
    with col3:
        st.markdown(f"""
            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 20px; border-radius: 12px; height: 250px;">
                ...
                <p style="font-size: 0.75rem; color: #475569; line-height: 1.4;"> Se trata de incrementar la aportación mensual y, por ejemplo, en el percibo de pagas extras destinar realizar una aportación extraordinaria hasta alcanzar el límite. 
            </div>
        """, unsafe_allow_html=True)
